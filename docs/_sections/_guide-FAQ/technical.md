...
<img src="{{ '/_assets/images/locate_file_7zip.png' | prepend: site.baseurl}}" alt="locate_file_7zip :(" width=300 height=200>
...
<img src="{{ '/_assets/images/extract_7zip.png' | prepend: site.baseurl }}" alt="path_7zip :(" width=300 height=200>
